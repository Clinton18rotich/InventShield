...
function AppContent() {
  ...
  return (<Router><Navbar lang={lang} setLang={setLang} dark={dark} setDark={setDark} notifications={notif} auth={auth} /><Routes><Route path="/login" element={<LoginPage users={users} setUsers={setUsers} lang={lang} dark={dark} auth={auth} />} /><Route path="/profile" element={<ProfilePage lang={lang} dark={dark} auth={auth} inventions={inv} users={users} setUsers={setUsers} />} /><Route path="/smartai" element={<GeminiChat dark={dark} />} /><Route path="/help" element={<HelpPage lang={lang} dark={dark} />} /><Route path="/" element={<Dashboard inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/discover" element={<DiscoverPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/add" element={<AddInventionPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/records" element={<RecordsPage inventions={inv} lang={lang} dark={dark} />} /><Route path="/revenue" element={<RevenueDashboard inventions={inv} lang={lang} dark={dark} />} /><Route path="/vault/:id" element={<VaultPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/draft/:id" element={<DraftPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/funding" element={<FundingPage lang={lang} dark={dark} />} /><Route path="/mentors" element={<MentorsPage lang={lang} dark={dark} />} /><Route path="/legalhub" element={<LegalHub dark={dark} />} /><Route path="/legal" element={<LegalPage lang={lang} dark={dark} />} /><Route path="/certify" element={<CertifyPage lang={lang} dark={dark} />} /><Route path="/analytics" element={<AnalyticsDashboard inventions={inv} lang={lang} dark={dark} />} /><Route path="/protection" element={<ProtectionHub inventions={inv} setInventions={setInv} lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/boost" element={<BoostCenter inventions={inv} setInventions={setInv} lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/share" element={<ShareHub inventions={inv} lang={lang} dark={dark} />} /><Route path="/messages" element={<MessageCenter inventions={inv} lang={lang} dark={dark} auth={auth} />} /><Route path="/nda" element={<NDAHub inventions={inv} lang={lang} dark={dark} />} /><Route path="/ratings" element={<RatingsPage inventions={inv} lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/export" element={<PDFExport inventions={inv} lang={lang} dark={dark} />} /><Route path="/refer" element={<ReferralPage lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/calc" element={<FundingCalc lang={lang} dark={dark} />} /><Route path="/activity" element={<ActivityFeed inventions={inv} lang={lang} dark={dark} />} /><Route path="/bookmarks" element={<BookmarksPage inventions={inv} lang={lang} dark={dark} />} /><Route path="/compare" element={<ComparePage inventions={inv} lang={lang} dark={dark} />} /><Route path="/patents" element={<PatentSearch lang={lang} dark={dark} />} /><Route path="/team" element={<TeamPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/milestones" element={<MilestonesPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/email" element={<EmailCenter lang={lang} dark={dark} setNotifications={setNotif} />} /><Route path="/notifications" element={<NotificationHistory lang={lang} dark={dark} />} /><Route path="/investhub" element={<InvestorHub dark={dark} />} /><Route path="/invest" element={<InvestorPage inventions={inv} setInventions={setInv} lang={lang} dark={dark} auth={auth} />} /><Route path="/global" element={<GlobalPage lang={lang} dark={dark} />} /></Routes><MobileBottomNav lang={lang} dark={dark} /><SmartAIFloatingButton /></Router>)
}
